...
//Route::post('send-push-notification', [APINotificationController::class, 'send_push_notification']);
...
Route::middleware('auth:sanctum')->group(function () {
  ...
  Route::controller(APIAUthController::class)->group(function () {
    ...
    Route::post('store-device-token', 'storeDeviceToken')->name('store-device-token');
  ...
  Route::controller(APIHotelController::class)->group(function () {
    ...
    Route::post('view-booking-details', 'viewBookingDetails')->name('view-booking-details');
