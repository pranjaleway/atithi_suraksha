...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <form id="reportForm" class="reportForm">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="input-group input-group-merge">
                                <div class="form-floating form-floating-outline">
                                    <select class="form-select" name="police_station_id" id="police_station_id">
        ...
        <div class="card police_station_count d-none mt-2">
            <div class="card-datatable table-responsive pt-0">
                <table class="table police_station_count_table" id="police_station_count_table">
                    <thead>
                        <tr>
                            <th>S.No</th>
                            <th>Hotel Count</th>
...
@section('scripts')
    <script>
        ...
        var listUrl = "{{ route('super-admin-report') }}";
    </script>
    <script src="{{ asset('assets/custom-js/tables-datatables-report-super-admin.js') }}"></script>
