    ...
    try {
        ...
        if ($userType == 4) {
            ...
            $request->validate([
                ...
                'aadhar_number' => 'required|numeric|digits:12|unique:hotels,aadhar_number,' . $hotel->id,
                'pan_number' => 'required|string|max:10|unique:hotels,pan_number,' . $hotel->id,
                'license_number' => 'required|string|max:255|unique:hotels,license_number,' . $hotel->id,
