            ...
            <div class="card-body p-1">
                <div class="tab-content p-0">
                    <div class="tab-pane fade show active" id="navs-top-general-info" role="tabpanel">
                        <form id="profile-details-form" action="{{ route('update-hotel-profile') }}" method="POST">
                            @csrf
                            ...
                            <div class="tab-content pb-1">
                                <div id="profile-details" class="tab-pane fade show active">
                                    <div class="row">
                                        <div class="mb-3 col-md-6 fv-plugins-icon-container">
                                            <div class="form-floating form-floating-outline">
                                                <input type="text" class="form-control" id="hotel_name" name="hotel_name"
                                                    placeholder="Hotel Name" aria-label="Hotel Name"
                                        ...
                                        <div class="mb-3 col-md-6 fv-plugins-icon-container">
                                            <div class="form-floating form-floating-outline">
                                                <input class="form-control" type="text" name="owner_name" id="owner_name"
                                                    placeholder="Hotel Owner Name" value="{{ Auth::User()->name }}" />
                                        ...
                                        <div class="mb-3 col-md-6 fv-plugins-icon-container">
                                            <div class="form-floating form-floating-outline">
                                                <input type="number" class="form-control" id="contact_number"
                                                    ...
                                                    aria-label="Contact Number" value="{{ $hotel->contact_number }}" />
                                        ...
                                        <div class="mb-3 col-md-6 fv-plugins-icon-container">
                                            <div class="form-floating form-floating-outline">
                                                <input class="form-control" type="number" id="owner_contact_number"
                                                    ...
                                                    value="{{ $hotel->owner_contact_number }}" />
                                        ...
                                        <div class="mb-3 col-md-6 fv-plugins-icon-container">
                                            <div class="form-floating form-floating-outline">
                                                <input class="form-control" type="text" id="pan_number" name="pan_number"
                                                    placeholder="Pan Number" value="{{ $hotel->pan_number }}" />
                                                ...
                                                <select class="form-select" id="state_id" name="state_id">
                                                    ...
                                                    @foreach ($states as $state)
                                                        <option value="{{ $state->id }}"
                                                            @isset($hotel)
                                                                {{ $hotel->state_id == $state->id ? 'selected' : '' }}
                                                            @endisset>
                                                            {{ $state->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        @if ($hotel->ownerDocuments->count())
                                            <div class="row mt-4" id="uploaded-preview-row">
                                                <h5>Uploaded Documents</h5>
                                                @foreach ($hotel->ownerDocuments as $doc)
