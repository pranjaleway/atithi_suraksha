...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme dark-menu">
    ...
    <ul class="menu-inner py-1">
        ...
        @if (hasPermission('room-master', 'view') && (Auth::user()->user_type_id == 4 || Auth::user()->user_type_id == 5))
            <li class="menu-item {{ Request::is('room-master') ? 'active' : '' }}">
        ...
        @if (hasPermission('notifications', 'view'))
            <li class="menu-item {{ Request::is('alerts') ? 'active' : '' }}">
                <a href="{{ route('alerts') }}" class="menu-link text-white">
                    <i class="menu-icon tf-icons mdi mdi-alert-box-outline"></i>
                    <div data-i18n="Add Alert">Add Alert</div>
                </a>
            </li>
        @endif
